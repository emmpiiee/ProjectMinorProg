...
//                    return directoryURL.URLByAppendingPathComponent(pathComponent)
//                }
//                client.files.download(path: "/2015-07-21 08.53.08-1 kopie.jpg", destination: destination).response { response, error in
//                    if let (metadata, url) = response {
//                        print("*** Download file ***")
//                        let data = NSData(contentsOfURL: url)
//                        let picture = UIImage (data: data!)
...
//                        filenames?.append(entry.name)
//                    }
//                    print("filenames in listbla bla : \(filenames)")
//                    }
//            } else {
//                print(error!)
//                }
...
//                    print("Downloaded file name: \(metadata.name)")
//                    print("Downloaded file url: \(url)")
//                    print("filenames 2 are \(filenames)")
//                    fileImages?.append(picture!)
//                    let newPost = Post.init(creator: "joe", image: picture!, caption: "test")
//                    Post.feed!.append(newPost)
//                } else {
